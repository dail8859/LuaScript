...
-- 
-- Some Scintilla messages, such as "<code>SCI_SETxxx</code>" and "<code>SCI_GETxxx</code>", are implemented in LuaScript as a single property. For example `Editor.CurrentPos` is a read/write property that calls both "<code>SCI_GETCURRENTPOS</code>" and "<code>SCI_SETCURRENTPOS</code>". The automatically generated documentation below may only refer to one or the other.
-- 
